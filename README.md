...
4. Install PGADMIN 'https://www.pgadmin.org/download/' and set up connection & create `artists_db` database and run the init.sql file which is in artists_db_init directory.
